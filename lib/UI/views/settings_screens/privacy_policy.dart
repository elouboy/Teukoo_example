...
Welcome to Teukoo.
Teukoo (“us”, “we”, or “our”) operates social network mobile application (hereinafter referred
to as “Service”).
Our Privacy Policy governs your visit to social network mobile application, and explains how
...
SERVICE means the social network mobile application operated by Teukoo.
...
Teukoo uses the collected data for various purposes:
...
Teukoo will take all the steps reasonably necessary to ensure that your data is treated
...
business;
  ...
  (iv) if we believe disclosure is necessary or appropriate to protect the rights, property, or
...
have certain data protection rights, covered by GDPR. – See more at https://eurlex.europa.eu/eli/reg/2016/679/oj
...
removed from our systems, please email us at contact@teukoo.com.
...
https://consumercal.org/about-cfc/cfc-education-foundation/california-online-privacyprotection-act-caloppa-3/
...
(a) What personal information we have about you. If you make this request, we will return
to you:
...
(c) To stop selling your personal information. We don't sell or rent your personal
...
Bitrise is a Continuous Integration and Delivery (CI/CD) Platform as a Service with a main
focus on mobile app development (iOS, Android, React Native, Flutter, and so on).
For more information on what data Bitrise collects for what purpose and how the protection of
the data is ensured, please visit Bitrise Privacy Notice page: https://www.bitrise.io/privacy.
...
platforms.
For more information on what data Circle CI collects for what purpose and how the protection
of the data is ensured, please visit Circle CI Privacy Policy page: https://circleci.com/privacy/.
